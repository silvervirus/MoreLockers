...
namespace MoreDeco
{
    ...
    public class Pa8
    {
       public static TechType techType;
        ...
        {
            BuildablePa8.Register();
        }
    }

    public static class BuildablePa8
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Partifact8", " Precursor Artifact 8", "A Precursor sword.")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("artifact8"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "e1aea389-5838-4360-adbd-d12f8d4f717b");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("alien_relic_08_world_rot").gameObject;
