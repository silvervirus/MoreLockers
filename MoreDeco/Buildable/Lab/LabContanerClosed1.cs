...
namespace MoreDeco
{
    ...
    public class LabClosed1
    {
       public static TechType techType;
        public static void Patch()
        {
            Buildablelabopen.Register();
        }
    }

    public static class Buildablelabopen
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Olab", " Closed Lab Container", "A lab container.")
            // set the icon to that of the vanilla locker:
            .WithIcon(SpriteManager.Get(TechType.LabContainer));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "e7f9c5e7-3906-4efd-b239-28783bce17a5");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("biodome_lab_containers_close_01").gameObject;
