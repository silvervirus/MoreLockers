...
namespace MoreDeco
{
    ...
    public class WallMonitor3
    {
       public static TechType techType;
        public static void Patch()
        {
            Buildablewallmonitor3.Register();
        }
    }

    public static class Buildablewallmonitor3
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Wmonior3", "Wall Monitor", "A Monitor for the wall .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("WallScreen3"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "cb612e1b-d57a-44f5-a043-a886eb17e5a6");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("Starship_wall_monitor_01_03").gameObject;
