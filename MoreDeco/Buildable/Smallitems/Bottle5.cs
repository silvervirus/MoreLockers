...
namespace MoreDeco
{
    ...
    public class Bottle5
    {
       public static TechType techType;
        public static void Patch()
        {
            BuildableBottle5.Register();
        }
    }

    public static class BuildableBottle5
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Bottle5", " Bottlezz", "A Bottle .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("Bottlezz"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "41399588-124d-4e01-92b7-f5b10c882ac8");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_bottle_05").gameObject;
