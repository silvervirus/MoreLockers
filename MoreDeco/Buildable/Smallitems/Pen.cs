...
namespace MoreDeco
{
    ...
    public class Pen
    {
       public static TechType techType;
        ...
        {
            Buildablepen.Register();
        }
    }

    public static class Buildablepen
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Pen", " Pen", "A Pan .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("Pen"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "01cdbef6-f07e-422a-b03a-5caf409da6d9");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_clerical_pen1").gameObject;
