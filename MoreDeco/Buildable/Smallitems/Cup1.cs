...
namespace MoreDeco
{
    ...
    public class Cup
    {
       public static TechType techType;
        ...
        {
            BuildableCup.Register();
        }
    }

    public static class BuildableCup
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Cup", " Cups", "A Cup .")
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "8c7205cd-ba0d-4fc7-b942-aa05d9753d57");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_cup_01").gameObject;
