...
namespace MoreDeco
{
    ...
    public class Bottle4
    {
       public static TechType techType;
        ...
        {
            BuildableBottle4.Register();
        }
    }

    public static class BuildableBottle4
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Bottle4", " Bottlez", "A Bottle .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("Bottlezzz"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "5c767a21-a317-4caf-b734-27f614e9a1ee");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_bottle_04").gameObject;
