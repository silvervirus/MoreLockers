...
namespace MoreDeco
{
    ...
    public class Bottle3
    {
       public static TechType techType;
        ...
        {
            BuildableBottle3.Register();
        }
    }

    public static class BuildableBottle3
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Bottle3", " Bottles", "A Bottle .")
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "d53cfbf1-f14d-4e9b-b8bb-cc65e734a9c5");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_bottle_03").gameObject;
