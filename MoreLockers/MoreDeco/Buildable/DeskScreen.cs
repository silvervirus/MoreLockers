...
namespace MoreDeco
{
    ...
    public class DeskScreen
    {
       public static TechType techType;
        ...
        {
            BuildableDScreen.Register();
        }
    }

    public static class BuildableDScreen
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("DScreen", "Desk Screen", "A Desk screen.")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("DeskScreen"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "2de0fc33-0386-4b55-84d4-6ad6bffaf74f");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("Starship_work_desk_screen_01").gameObject;
