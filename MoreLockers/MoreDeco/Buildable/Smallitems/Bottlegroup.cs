...
namespace MoreDeco
{
    ...
    public class BottleGroup
    {
       public static TechType techType;
        ...
        {
            BuildableBottleGroup.Register();
        }
    }

    public static class BuildableBottleGroup
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("gBottle", "Group of Bottle", "A Group of Bottles .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("BottleGroup"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "9925060f-6ffd-4979-a4d0-1a74bd8fd16d");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_bottlegroup_01").gameObject;
