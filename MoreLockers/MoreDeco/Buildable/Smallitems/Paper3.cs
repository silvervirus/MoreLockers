...
namespace MoreDeco
{
    ...
    public class paper3
    {
       public static TechType techType;
        ...
        {
            Buildablepaper3.Register();
        }
    }

    public static class Buildablepaper3
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("paper3", "Paper3", "A paper .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("paper3"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "32e48451-8e81-428e-9011-baca82e9cd32");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_clerical_paper7").gameObject;
