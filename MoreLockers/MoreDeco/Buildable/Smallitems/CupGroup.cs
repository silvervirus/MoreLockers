...
namespace MoreDeco
{
    ...
    public class CupGroup
    {
       public static TechType techType;
        ...
        {
            BuildableCupgroup.Register();
        }
    }

    public static class BuildableCupgroup
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Gcup", " Group Of Cups", "A group of Cups .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("CupGroup"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "e9b7f02b-ed87-4a49-aa19-00c1d894c696");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_cupgroup_01").gameObject;
