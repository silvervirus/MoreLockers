...
namespace MoreDeco
{
    ...
    public class Bottle2
    {
       public static TechType techType;
        ...
        {
            BuildableBottle2.Register();
        }
    }

    public static class BuildableBottle2
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("Bottle2", " Bottle2", "A Bottle .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("Bottles"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "ff9b4394-e7d3-42e6-b924-585af2d0e03f");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_bottle_02").gameObject;
