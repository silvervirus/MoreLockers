...
namespace MoreDeco
{
    ...
    public class Cup2
    {
       public static TechType techType;
        ...
        {
            BuildableCup2.Register();
        }
    }

    public static class BuildableCup2
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("2cup", " Number Two Cup", "another cups .")
            // set the icon to that of the vanilla locker:
            .WithIcon(Utilities.GetSprite("Cup2"));
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "02937419-3b3e-4a4e-a111-384fb7d970c2");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("docking_bar_cup_02").gameObject;
