...
namespace MoreLockers
{
    ...
    public class Keypad
    {
       public static TechType techType;
        ...
        {
            Buildablekeypad.Register();
        }
    }

    public static class Buildablekeypad
    {
        public static PrefabInfo Info { get; } = PrefabInfo.WithTechType("keypad", "Door Keypad", "A Door Keypad.")
        ...
        public static void Register()
        {
            ...
            CloneTemplate lockerClone = new CloneTemplate(Info, "48a5564b-e632-4666-9e7c-f377fbc4fd23");
            ...
            lockerClone.ModifyPrefab += obj =>
            {
                ...
                GameObject model = obj.transform.Find("Keypad1").gameObject;
