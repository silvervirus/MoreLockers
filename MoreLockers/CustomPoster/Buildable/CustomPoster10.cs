...
namespace CustomPoster
{
    ...
    public class CustomPoster10

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster10");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster10", "CustomPoster10", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster10"), 2, 3);
