...
namespace CustomPoster
{
    ...
    public class CustomPoster19

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster19");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster19", "CustomPoster19", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster19"), 2, 3);
