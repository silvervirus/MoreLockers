...
namespace CustomPoster
{
    ...
    public class CustomPoster4

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster4");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster4", "CustomPoster4", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster4"), 2, 3);
