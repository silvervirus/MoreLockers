...
namespace CustomPoster
{
    ...
    public class CustomPoster7

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster7");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster7", "CustomPoster7", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster7"), 2, 3);
