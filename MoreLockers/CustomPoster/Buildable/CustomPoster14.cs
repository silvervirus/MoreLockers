...
namespace CustomPoster
{
    ...
    public class CustomPoster14

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster14");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster14", "CustomPoster14", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster14"), 2, 3);
