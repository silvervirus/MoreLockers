...
namespace CustomPoster
{
    ...
    public class CustomPoster15

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster15");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster15", "CustomPoster15", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster15"), 2, 3);
