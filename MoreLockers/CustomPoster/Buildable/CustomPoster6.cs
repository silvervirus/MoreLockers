...
namespace CustomPoster
{
    ...
    public class CustomPoster6

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster6");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster6", "CustomPoster6", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster6"), 2, 3);
