...
namespace CustomPoster
{
    ...
    public class CustomPoster13

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster13");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster13", "CustomPoster13", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster13"), 2, 3);
