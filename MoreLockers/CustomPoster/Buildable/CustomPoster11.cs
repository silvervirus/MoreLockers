...
namespace CustomPoster
{
    ...
    public class CustomPoster11

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster11");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster11", "CustomPoster11", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster11"), 2, 3);
