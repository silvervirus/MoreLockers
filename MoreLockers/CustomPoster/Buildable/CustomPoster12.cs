...
namespace CustomPoster
{
    ...
    public class CustomPoster12

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster12");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster12", "CustomPoster12", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster12"), 2, 3);
