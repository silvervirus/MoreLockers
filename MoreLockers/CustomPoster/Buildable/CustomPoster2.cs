...
namespace CustomPoster
{
    ...
    public class CustomPoster2

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster2");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster2", "CustomPoster2", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster2"), 2, 3);
