...
namespace CustomPoster
{
    ...
    public class CustomPoster17

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster17");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster17", "CustomPoster17", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster17"), 2, 3);
