...
namespace CustomPoster
{
    ...
    public class CustomPoster20

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster20");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster20", "CustomPoster20", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster20"), 2, 3);
