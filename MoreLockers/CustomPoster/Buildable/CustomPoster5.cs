...
namespace CustomPoster
{
    ...
    public class CustomPoster5

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster5");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster5", "CustomPoster5", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster5"), 2, 3);
