...
namespace CustomPoster
{
    ...
    public class CustomPoster3

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster3");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster3", "CustomPoster3", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster3"), 2, 3);
