...
namespace CustomPoster
{
    ...
    public class CustomPoster8

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster8");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster8", "CustomPoster8", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster8"), 2, 3);
