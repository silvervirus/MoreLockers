...
namespace CustomPoster
{
    ...
    public class CustomPoster18

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster18");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster18", "CustomPoster18", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster18"), 2, 3);
