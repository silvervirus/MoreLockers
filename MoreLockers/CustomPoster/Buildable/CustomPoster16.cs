...
namespace CustomPoster
{
    ...
    public class CustomPoster16

    {
        public static Texture2D TestPhoto = Utilities.GetTexture("CustomPoster16");
...

        {
            ...
            Info = Utilities.CreatePrefabInfo("CustomPoster16", "CustomPoster16", "Wall Mounted Poster.", Utilities.GetSprite("CustomPoster16"), 2, 3);
